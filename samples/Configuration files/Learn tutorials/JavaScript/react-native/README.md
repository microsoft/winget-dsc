# Install React Native for Windows support in Visual Studio Code

This folder contains [Windows Package Manager](https://learn.microsoft.com/windows/package-manager/winget/) (WinGet) [Configuration Files](https://learn.microsoft.com/windows/package-manager/configuration/) for setting up a React Native for Windows development environment using Visual Studio Code.
...
- Windows Terminal
- React Native Tools extension for VS Code
...
A v3 version of each configuration is also available (e.g., `learn_react_native_vscode.v3.winget`) using the dscv3 processor syntax with explicit module installs.
