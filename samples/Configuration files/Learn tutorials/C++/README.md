...
A v3 version of each configuration is also available (e.g., `learn_cpp_vs_community.v3.winget`) using the dscv3 processor syntax with explicit module installs.
