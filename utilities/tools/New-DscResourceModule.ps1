...
$moduleManifestParams = @{
    ...
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @('*') # Export all aliases as a workaround for a bug in New-ModuleManifest. See: https://github.com/PowerShell/PSDesiredStateConfiguration/issues/101
